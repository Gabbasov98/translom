...
let coord = [55.755864, 37.617698]
let mapPoints = [
    {
        id: "1",
        cords: [55.766278, 37.676385]
    },
    {
        id: "2",
        cords: [55.628754, 37.819954]
    },
    {
        id: "3",
        cords: [56.502286, 60.810034]
    },
    {
        id: "4",
        cords: [58.286791, 57.720826]
    },
]
        ...
        mapPoints.forEach((el,index) => {
            let placeMark = new ymaps.Placemark(el.cords, {
                ...
                },
                {
                    ...
                    iconImageHref: 'img/pin2.svg',
                    iconImageSize: [56, 63],
                    iconImageOffset: [-28, -31.5],
                    hideIconOnBalloonOpen: false,
                    iconContentLayout: ymaps.templateLayoutFactory.createClass(
                        '<div style="color: #FFFFFF; font-weight: bold;">12</div>'
                    )
                }
            );
            ...
            placeMark.events
                .add('click', function (e) {
                    let mapsPopups = document.querySelectorAll(".map-modal")
                    mapsPopups.forEach(popup => {
                        let close = popup.querySelector(".map-modal__close")
